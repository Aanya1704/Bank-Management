...
+ "<td> <input type='text' name = 'aname' value='"+rs.getString("aname")+"'" + "</tr>"
+ "<tr> "
+ "<td> <label> Balance = </label> </td>"+ "<td> <input type='text' name='abal' readonly value='"+rs.getInt("abal")+"'" + "</tr>"
+ "<tr>"
...
{
pw.print("<h3 align='center'>No Such Record - Try </h3>"); 
