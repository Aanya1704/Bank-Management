...
pw.print("<table align = 'center'>" + "<tr> " + "<td> <label> Account Number = </label> </td>"+ "<td> <input type='text' readonly value='"+ rs.getInt("anum") + "'" + "</tr>" + "<tr> "+ "<td> <label> Account Name = </label> </td>" + "<td> <input type='text' readonly value='"+ rs.getString("aname") + "'" + "</tr>" +"<tr> " + "<td> <label> Balance = </label> </td>"+ "<td> <input type='text' readonly value='"+ rs.getInt("abal") + "'" + "</tr>"+ "</table");
} else {
